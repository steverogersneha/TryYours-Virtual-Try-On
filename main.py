...
if __name__ == '__main__':
    ...
    terminal_command ="python3 exp/inference/inference.py --loadmodel ./inference.pth --img_path ../resized_img.jpg --output_path ../ --output_name /resized_segmentation_img"
    os.system(terminal_command)
    os.chdir("../")
    ...
    terminal_command ="python3 get_seg_grayscale.py"
    os.system(terminal_command)

    # Generate Densepose image using detectron2 library
    print("\nGenerate Densepose image using detectron2 library\n")
    terminal_command ="python3 detectron2/projects/DensePose/apply_net.py dump detectron2/projects/DensePose/configs/densepose_rcnn_R_50_FPN_s1x.yaml \
    https://dl.fbaipublicfiles.com/densepose/densepose_rcnn_R_50_FPN_s1x/165712039/model_final_162be9.pkl \
    origin.jpg --output output.pkl -v"
    os.system(terminal_command)
    terminal_command ="python3 get_densepose.py"
    os.system(terminal_command)
